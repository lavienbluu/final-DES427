  ...
  return (
    <View style={styles.container}>
      <View style={styles.group1}>
        ...
        {'\n'}✨ Random to find the interesting facts about date
        </Text>
      </View>
      <View style={styles.group2}>
        <Text style={styles.command}>{'\n'}Please enter your number</Text>
        <Text style={styles.title}>{'\n'}Example: Type '01/22' (Month/Date) or 'random'</Text>
        ...
        <TextInput 
            ...
            <NumButton value = {value} type = 'date' onPress = {changeIndex}></NumButton>
        </View>
